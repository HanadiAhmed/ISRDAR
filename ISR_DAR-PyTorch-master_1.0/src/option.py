...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/tsg723/dataset',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='/home/tsg723/dataset',
...
parser.add_argument('--data_range', type=str, default='1-30/1-5',
...
parser.add_argument('--model', default='ISRDARNET',
                    help='model name')
parser.add_argument('--n_Blk', type=int, default=16,
...
# Log specifications
parser.add_argument('--save', type=str, default='ISRDARNET',
                    help='file name to save')
parser.add_argument('--load', type=str, default='ISRDARNET',
...
# New options
parser.add_argument('--testpath', type=str, default='/home/tsg723/dataset',
